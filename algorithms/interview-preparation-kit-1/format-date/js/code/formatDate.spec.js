...
describe('Format Date', () => {
  ...
  test.skip('long format of 1976', () => {
    expect(longFormat('1976')).toBe('Invalid data input');
  });

  test.skip('long format of aaa', () => {
