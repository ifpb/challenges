...
describe "The Library of Mr Severino" do
  context "sort codes collection 3000, 2000, 1000" do
    it "it 1000,2000,3000" do
      ...
      expect(sort_library(codes)).to eq(expected)
    end
  end    
end

describe "The Library of Mr Severino" do
  context "sort codes collection 1233, 0015, 0100" do
...
describe "The Library of Mr Severino" do
  context "sort codes collection 0752, 1110, 0001, 6322, 8000, 6321, 0000" do
