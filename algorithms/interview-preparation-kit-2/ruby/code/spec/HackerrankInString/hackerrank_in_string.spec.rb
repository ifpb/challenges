...
describe "Hackerrank In String" do
  ...
  xcontext "hackerrank exist in hackerworld" do
    it "NO" do
      expect(HackerrankInString.check('hackerworld')).to eq('NO')
    end
  end    

  xcontext "hackerrank exist in hhaacckkekraraannk" do
    it "YES" do
      expect(HackerrankInString.check('hhaacckkekraraannk')).to eq('YES')
    end
  end    

  xcontext "hackerrank exist in rhbaasdndfsdskgbfefdbrsdfhuyatrjtcrtyytktjjt" do
    it "NO" do
