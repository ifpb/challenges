...
describe('Birthday Cake Candles', () => {
  ...
  test.skip('2 candles that can be blown in [1, 3, 1, 3]', () => {
    expect(birthdayCakeCandles([1, 3, 1, 3])).toBe(2);
  });

  test.skip('3 candles that can be blown in [1, 3, 3, 3]', () => {
    expect(birthdayCakeCandles([1, 3, 3, 3])).toBe(3);
  });

  test.skip('2 candles that can be blown in [3, 2, 1, 3]', () => {
    expect(birthdayCakeCandles([3, 2, 1, 3])).toBe(2);
  });

  test.skip('5 candles that can be blown in [18, 90, 90, 75, 90, 8, 90, 43]', () => {
