import { sortLibrary } from './sortLibrary.js.js';
...
describe('The Library of Mr Severino', () => {
  ...
  test.skip('sort codes collection 1233, 0015, 0100', () => {
    const codes = ['1233', '0015', '0100'];
    const expected = ['0015', '0100', '1233'];
    expect(sortLibrary(codes)).toEqual(expected);
  });

  test.skip('sort codes collection 0752, 1110, 0001, 6322, 8000, 6321, 0000', () => {
